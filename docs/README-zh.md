...
| 文件 | 内容 |
|------|------|
| [docs/OPERATIONS.md](OPERATIONS.md) | 运维一页纸：日常检查 / 发收任务 / 排障 / plan 模板 |
| [docs/AGENT-CONTRACT.md](AGENT-CONTRACT.md) | Agent 工作契约（含 Hermes 派活 + 第三方审查） |
| [docs/E2E.md](E2E.md) | E2E 与 smoke |
| [docs/SETUP.md](SETUP.md) | 安装与 OAuth |
| [docs/PRINCIPLES.md](PRINCIPLES.md) | 原则 |
| [docs/MEMORY.md](MEMORY.md) | 踩坑与决策 |
